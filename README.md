...
This project is a Proof of Concept (POC) for a Movie Recommendation System. The goal of this system is to provide personalized recommendations to users based on their preferences and behavior using [The Movies Dataset](https://www.kaggle.com/datasets/rounakbanik/the-movies-dataset?resource=download).
